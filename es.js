const es = {
	...
	targets: {
		object_types: {
			Stars: "Estrellas",
			Planets: "Planetas",
			OpenClusters: "Cúmulos abiertos",
			GlobularClusters: "Cúmulos globulares",
			GaseousNebulae: "Nebulosas gaseosas",
			PlanetaryNebulae: "Nebulosas planetarias",
			Galaxies: "Galaxias",
			Comets: "Cometas",
		...
		magnitude: "Magnitud",
		usable_duration: "Duración utilizable",
		start: "Inicio",
		end: "Fin",
		...
		wind: "Viento",
		gust: "ráfaga",
		no_forecast_data: "Aún no hay datos de pronóstico para esta ubicación.",
		moon: "Luna",
		sun: "Sol",
		search: "Buscar",
	...
	cloud: {
		...
		gallery_drawer: {
			...
			delete_all_action: "Borrar Todo",
			delete_folder: "Eliminar Carpeta",
			files_in_folder: "Archivos en esta carpeta",
			frames: "Fotogramas",
			frame_rate: "Velocidad de fotogramas",
			used_free: "{0} usado · {1} libre",
			recent: "Reciente",
			playback_unsupported:
				"La reproducción no es compatible con este tipo de archivo",
		},
		info_drawer: {
	...
	stella: {
		...
		clear_chat_confirm: "Esto eliminará permanentemente tu historial de conversación con Stella.",
		try_asking: "Prueba a preguntar",
		show_suggestions: "Mostrar sugerencias",
		thinking: "Stella está pensando…",
		input_placeholder: "Pide a Stella que enfoque, capture o ejecute una secuencia…",
		waiting_response: "Esperando la respuesta de Stella…",
		attach_image: "Adjuntar imagen",
		voice_input: "Entrada de voz",
		sequence_ready: "Secuencia de captura lista",
		scheduler_ready: "Tarea del planificador lista",
		prompts_left: "consultas restantes",
		notifications: {
	...
	postprocessing: {
		...
		btn_publish_ekoslive: "Publicar",
		publish_no_image: "Procese una imagen antes de publicarla en EkosLive.",
		publish_failed_title: "Error al publicar",
		publish_failed_body: "Se produjo un error al preparar la imagen para EkosLive.",
		publish_no_equipment: "Configure un observatorio y un perfil de equipo en EkosLive antes de publicar.",
		publish_dialog_title: "Publicar en EkosLive",
		publish_using: "Usando {0} · {1}",
		publish_frames_summary: "{0} filtros · {1} h de integración total",
		publish_success: "Publicado en EkosLive.",
		btn_cancel: "Cancelar",
		keep_editing: "Seguir editando",
		method: "Método",
		stretch_linked: "Vincular canales",
		stretch_neutralize: "Neutralizar fondo",
		btn_defaults: "Predeterminados",
		reset_step: "Restaurar los valores predeterminados de este paso",
		confirm_defaults_title: "¿Restablecer todos los ajustes a los valores predeterminados?",
		confirm_defaults_body: "Los ajustes actuales de este paso se descartarán.",
		...
		stretch_curve_description: "Se aplica sobre el autoestirado; desactívela para estirar solo con el autoestirado.",
		stretch_manual_description: "Sin autoestirado: la curva estira la imagen por sí misma, proyectada sobre su propio rango de brillo.",
		stretch_manual_range: "Sin autoestirado: la curva estira la imagen por sí misma, proyectada sobre su propio rango de brillo ({0} a {1}).",
		stretch_rerun_blocked: "El estirado ya está aplicado y ya no es el último cambio de la imagen, así que esta ejecución no puede reemplazarlo: apilaría un segundo estirado sobre el primero. Vuelva a ejecutar el proceso desde el paso Apilar para estirar de nuevo desde la imagen lineal.",
		...
		combine_normalize: "Igualar canales",
		...
		finalize_failed_reason: "Se ha producido un error al guardar el resultado en la biblioteca: {0}",
		finalize_busy_reason: "otro paso sigue en ejecución en esta imagen",
		...
		resume_title: "¿Reanudar la sesión anterior?",
		resume_body: "Se encontraron resultados anteriores en {0}. Reanudar continúa desde la imagen guardada en lugar de recalibrar y apilar de nuevo. Empezar de nuevo eliminará el contenido de esa carpeta.",
		resume_failed_title: "Error al reanudar",
		resume_failed_body: "No se pudo cargar el resultado anterior: {0}",
		btn_resume: "Reanudar",
		btn_start_fresh: "Empezar de nuevo",
		fresh_cleanup_failed_title: "No se pudieron borrar los resultados anteriores",
		fresh_cleanup_failed_body: "Se empezará de nuevo igualmente, pero no se pudieron eliminar los archivos anteriores: {0}",
	},
	wizard: {
