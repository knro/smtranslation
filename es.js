const es = {
	...
	connect: {
		...
		observatory: {
			...
			stream_access: "Acceso a transmisión de video en vivo",
			public_access: "Acceso público",
			connect_angelcam: "Conectar con Angelcam",
			no_cameras_available: "No hay cámara disponible. Por favor conecta con Angelcam para acceder a tus cámaras.",
	...
	about: {
		...
		bundle: "Empaquetado",
		copyright_line1:
			"StellarMate esta desarrollado por Ikarus Technologies © 2017-2025",
