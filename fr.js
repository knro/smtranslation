    ...
    "ekos": {
       ...
       "collapse_align": {
          ...
          "manualRotator": {
            ...
            "currentPA": "PA Actuel",
            "targetPA": "PA Cible",
            "another_image": "Prendre une utre Image",
        },
        "alignSettings": {
         "rotator_control": "Contrôle Rotateur",
         "use_scale": "Utiliser échelle",
       ...
       "collapse_polar": {
          ...
          "mount_direction": "Direction dz la monture",
       ...
       "collapse_mount": {
          "meridian_flip": "Rotation au Méridien",
          "flip_if_ha": "Retourner si HA>",
          "flip_if_ha_unit": "°",
          "pierside": "Côté de la jetée",
          "auto_park": "Parcking automatique",
      ...
      "scheduler": {
         ...
         "priority": "Priorité",
         "profile": "Profil",
         "startupConditions": "Conditions  de démarrage des tâches",
         "JobConstraints": "Contraintes pour les tâches",
         "completionConditions": "Conditions de terminaison des tâches",
         "observatoryStartup": "Procédure de démarrage de l'observation",
         "abortedJobManagement": "Gestion des tâches annulées",
         "observatoryShutdown": "Procédure d'arrêt de l'observation",
         "alt": "Alt >",
         "moon": "Lune >",
         "twilight": "Aube",
         "artifHorizon": "Horizon Artificiel",
         "sequenceCompletion": "Achèvement des séquences",
         "repeatFor": "Repeter pour",
         "repeatUntilTerminated": "Répéter jusqu'à terminaison",
         "repeatUntil": "Repéter jusqu'à",
         "unparkDome": "Débloquer le Dôme",
         "unparkMount": "Déloquer la Monture",
         "uncap": "Enlever la coiffe",
         "warmCCD": "Réchauffer  le Capteur",
         "none": "None",
         "queue": "Queue",
         "immediate": "Immmédiat",
         "rescheduleErrors": "Reschedule Errors (seconds wait)",
         "no_jobs": "Pas de tâches dans la file d'attente",
