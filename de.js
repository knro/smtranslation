const de = {
	...
	cloud: {
		...
		filters_drawer: {
			...
			contains: "Enthält",
			applied: "Angewendet",
			add_a_filter: "Filter hinzufügen",
		},
		gallery_drawer: {
			all: "Alles",
			h1: "1h",
			...
			files_in_folder: "Dateien in diesem Ordner",
			frames: "Bilder",
			frame_rate: "Bildrate",
			used_free: "{0} verwendet · {1} frei",
			recent: "Kürzlich",
			playback_unsupported:
				"Wiedergabe wird für diesen Dateityp nicht unterstützt",
		},
		info_drawer: {
	...
	stella: {
		...
		clear_chat_confirm: "Dies löscht Ihren Gesprächsverlauf mit Stella dauerhaft.",
		try_asking: "Frag zum Beispiel",
		show_suggestions: "Vorschläge anzeigen",
		thinking: "Stella denkt nach…",
		input_placeholder: "Bitten Sie Stella, zu fokussieren, aufzunehmen oder eine Sequenz auszuführen…",
		waiting_response: "Warte auf Stellas Antwort…",
		attach_image: "Bild anhängen",
		voice_input: "Spracheingabe",
		sequence_ready: "Aufnahmesequenz bereit",
		scheduler_ready: "Planungsauftrag bereit",
		prompts_left: "verbleibende Anfragen",
		notifications: {
