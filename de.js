const de = {
    general: {
        ...
        alert_delete_profile_body: "Sind Sie sicher, dass Sie das ausgewählte Profil löschen möchten?",
        alert_delete_scope_body: "Sind Sie sicher, dass Sie das ausgewählte Teleskop löschen möchten?",
    ...
    achievements: {
        ...
        alert_agree_reset_body: "Sind Sie sicher, dass Sie alle Erfolge zurücksetzen möchten?"
    },
    tourGuide:
    {
    ...
    targets: {
        ...
        no_objects_in_list: "Keine Objekte gefunden. Bitte überprüfen Sie die aktive Liste, passen Sie die Filter an oder setzen Sie sie zurück..",
    ...
    ekos: {
        ...
        collapse_camera: {
            ...
            capture_settings: {
                ...
                reset_sequence_tooltip: "Wenn Sie mit der Verarbeitung einer Sequenzliste beginnen, setzen Sie alle Erfassungszähler auf Null zurück. Der Planer überschreibt diese Option, wenn „Auftragsfortschritt speichern“ aktiviert ist.",
    ...
    optical_train: {
        ...
        tooltip: {
            ...
            st4_device: "Wenn Sie ein ST4-Kabel zwischen Guide-Kamera und Halterung verwenden, sollten Sie die Guide-Kamera als Guider auswählen.",
            dedicated_device: "Wenn Sie ein dediziertes Guider-Schnittstellengerät (zB. Shoestring GPUSB) verwenden, wählen Sie es als Guider aus",
            dedicated: "Dediziert",
            filterWheel: "Wählen Sie ein Filterrad aus. Dabei muss es sich um ein eigenständiges Filterrad handeln, das über USB mit StellarMate verbunden ist. Wenn Sie ein Filterrad haben, das in eine Kamera integriert ist, lassen Sie dieses Feld leer."
        }
    },
    status: {
        system: "System",
        ...
        information_ekos_offline: 'Ekos ist offline. Bitte starten Sie das Geräteprofil direkt oder über den Scheduler.',
        ...
        alert_factory_reset_body: "Werkseinstellungen wiederhergestellt. Bitte starten Sie Stellarmate jetzt neu.",
        ...
        alert_update_complete_body: "Update abgeschlossen, bitte starten Sie StellarMate neu.",
        alert_network_error_title: "Netzwerk Fehler",
        alert_network_error_body: "Netzwerkinformationen konnten nicht abgefragt werden",
        alert_delete_directory_message: "Möchten Sie das Verzeichnis {0} und alle darin enthaltenen Dateien wirklich löschen?",

        alert_permission_title: "Erlaubnis für die Standortabfrage erteilen",
        alert_permission_description: "Die StellarMate-App benötigt Standortinformationen, um den Standort des StellarMate-Gadgets mit dem Standort der App zu synchronisieren. Möchten Sie fortfahren?",

        alert_remote_isactive: "Es konnte nicht überprüft werden, ob der Remote-Support aktiv ist. Ist Ihr StellarMate OS auf dem neuesten Stand?",
        ...
        alert_grant_camera_permission: "Sie müssen zuerst die Erlaubnis für den Zugriff auf die Kamera erteilen",
    ...
    settings: {
        ...
        alert_delete_account_body: "Sind Sie sicher, dass Sie Ihr Konto löschen möchten?",
    ...
    about: {
        heading: "Über",
        bundle: "Bündeln",
        copyright_line1: "StellarMate wurde von Ikarus Technologies entwickelt. © 2017-2024",
