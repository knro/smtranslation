const de = {
	...
	targets: {
		object_types: {
			Stars: "Sterne",
			Planets: "Planeten",
			OpenClusters: "Offene Sternhaufen",
			GlobularClusters: "Kugelsternhaufen",
			GaseousNebulae: "Gasnebel",
			PlanetaryNebulae: "Planetarische Nebel",
			Galaxies: "Galaxien",
			Comets: "Kometen",
		...
		magnitude: "Magnitude",
		usable_duration: "Nutzbare Dauer",
		start: "Start",
		end: "Ende",
		...
		wind: "Wind",
		gust: "Böe",
		no_forecast_data: "Noch keine Vorhersagedaten für diesen Standort.",
		moon: "Mond",
		sun: "Sonne",
		search: "Suche",
	...
	postprocessing: {
		...
		btn_publish_ekoslive: "Veröffentlichen",
		publish_no_image: "Verarbeiten Sie ein Bild, bevor Sie es auf EkosLive veröffentlichen.",
		publish_failed_title: "Veröffentlichung fehlgeschlagen",
		publish_failed_body: "Beim Vorbereiten des Bildes für EkosLive ist ein Fehler aufgetreten.",
		publish_no_equipment: "Richten Sie ein Observatorium- und Ausrüstungsprofil auf EkosLive ein, bevor Sie veröffentlichen.",
		publish_dialog_title: "Auf EkosLive veröffentlichen",
		publish_using: "Verwendet {0} · {1}",
		publish_frames_summary: "{0} Filter · {1} Std. Gesamtbelichtung",
		publish_success: "Auf EkosLive veröffentlicht.",
		btn_cancel: "Abbrechen",
		keep_editing: "Weiter bearbeiten",
		method: "Methode",
		stretch_linked: "Kanäle verknüpfen",
		stretch_neutralize: "Hintergrund neutralisieren",
		btn_defaults: "Standardwerte",
		reset_step: "Standardwerte dieses Schritts wiederherstellen",
		confirm_defaults_title: "Alle Einstellungen auf Standardwerte zurücksetzen?",
		confirm_defaults_body: "Die aktuellen Einstellungen dieses Schritts werden verworfen.",
		...
		stretch_curve_description: "Wird über die Auto-Streckung gelegt — ausgeschaltet bleibt nur die Auto-Streckung.",
		stretch_manual_description: "Keine Auto-Streckung: die Kurve selbst streckt das Bild, abgebildet auf den bildeigenen Helligkeitsbereich.",
		stretch_manual_range: "Keine Auto-Streckung: die Kurve selbst streckt das Bild, abgebildet auf den bildeigenen Helligkeitsbereich ({0} bis {1}).",
		stretch_rerun_blocked: "Die Streckung ist bereits angewendet und ist nicht mehr die letzte Änderung am Bild: Dieser Lauf kann sie nicht ersetzen, er würde eine zweite Streckung darüberlegen. Führen Sie die Pipeline ab dem Schritt Stapeln erneut aus, um vom linearen Bild aus neu zu strecken.",
		...
		combine_normalize: "Kanäle angleichen",
		...
		finalize_failed_reason: "Beim Speichern des Ergebnisses in der Bibliothek ist ein Fehler aufgetreten: {0}",
		finalize_busy_reason: "ein anderer Schritt läuft noch für dieses Bild",
		...
		resume_title: "Vorherige Sitzung fortsetzen?",
		resume_body: "In {0} wurden frühere Ergebnisse gefunden. Fortsetzen übernimmt das gespeicherte Bild, statt erneut zu kalibrieren und zu stacken. Neu starten löscht den Inhalt dieses Ordners.",
		resume_failed_title: "Fortsetzen fehlgeschlagen",
		resume_failed_body: "Das vorherige Ergebnis konnte nicht geladen werden: {0}",
		btn_resume: "Fortsetzen",
		btn_start_fresh: "Neu starten",
		fresh_cleanup_failed_title: "Frühere Ergebnisse konnten nicht gelöscht werden",
		fresh_cleanup_failed_body: "Es wird trotzdem neu gestartet, aber die vorherigen Dateien konnten nicht entfernt werden: {0}",
	},
	wizard: {
