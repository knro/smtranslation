const de = {
	...
	connect: {
		...
		observatory: {
			...
			stream_access: "Live-Video-Stream-Zugriff",
			public_access: "Öffentlicher Zugriff",
			connect_angelcam: "Mit Angelcam verbinden",
			no_cameras_available: "Keine Kamera verfügbar. Bitte verbinden Sie sich mit Angelcam, um auf Ihre Kameras zuzugreifen.",
