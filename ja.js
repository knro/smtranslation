const ja = {
	...
	cloud: {
		...
		gallery_drawer: {
			...
			ai_search: "AI検索",
			delete_all_action: "すべて削除",
			delete_folder: "フォルダを削除",
			files_in_folder: "このフォルダ内のファイル",
			frames: "フレーム",
			frame_rate: "フレームレート",
			used_free: "{0} 使用済み・{1} 空き",
			recent: "最近",
			playback_unsupported: "このファイル形式の再生はサポートされていません",
		},
		info_drawer: {
	...
	stella: {
		...
		narrate: "応答をナレーション",
		clear_chat: "チャットを消去",
		clear_chat_confirm: "Stellaとの会話履歴が完全に削除されます。",
		try_asking: "こう聞いてみましょう",
		show_suggestions: "候補を表示",
		thinking: "Stellaが考えています…",
		input_placeholder: "Stellaにフォーカス、撮影、シーケンスの実行を依頼…",
		waiting_response: "Stellaの応答を待っています…",
		attach_image: "画像を添付",
		voice_input: "音声入力",
		sequence_ready: "撮影シーケンスの準備ができました",
		scheduler_ready: "スケジュールジョブの準備ができました",
		prompts_left: "残りのプロンプト数",
		notifications: {
