const ja = {
	...
	targets: {
		...
		wind: "風速",
		gust: "突風",
		no_forecast_data: "この地点の予報データはまだありません。",
		moon: "月",
		sun: "太陽",
		search: "検索",
		cam_width: "カメラの幅",
	...
	ekos: {
		...
		collapse_polar: {
			...
			mount_rotation: "架台回転",
			refresh: "更新",
			getting_closer: "近づいています",
			moving_away: "離れています",
			waiting_for_update: "次の更新を待機中",
	...
	postprocessing: {
		...
		btn_finalize: "確定して保存",
		btn_save_short: "保存",
		btn_publish_ekoslive: "公開",
		publish_no_image: "EkosLive に公開する前に画像を処理してください。",
		publish_failed_title: "公開に失敗しました",
		publish_failed_body: "EkosLive 用に画像を準備中にエラーが発生しました。",
		publish_no_equipment: "公開する前に、EkosLive で観測所と機材プロファイルを設定してください。",
		publish_dialog_title: "EkosLive に公開",
		publish_using: "{0}・{1} を使用",
		publish_frames_summary: "{0} フィルター・総露光 {1} 時間",
		publish_success: "EkosLive に公開しました。",
		btn_cancel: "キャンセル",
		keep_editing: "編集を続ける",
		method: "方法",
		stretch_linked: "チャンネルをリンク",
		stretch_neutralize: "背景を中和",
		btn_defaults: "既定値",
		reset_step: "このステップの既定値に戻す",
		confirm_defaults_title: "すべての設定を既定値に戻しますか？",
		confirm_defaults_body: "このステップの現在の設定は破棄されます。",
		status_pending: "保留中",
		status_running: "実行中…",
		status_completed: "完了",
		...
		stretch_curve_description: "オートストレッチの上に適用されます。オフにするとオートストレッチのみで伸長します。",
		stretch_manual_description: "オートストレッチなし：カーブ自体が画像を伸長し、画像自身の明るさ範囲にマッピングされます。",
		stretch_manual_range: "オートストレッチなし：カーブ自体が画像を伸長し、その明るさ範囲（{0} ～ {1}）にマッピングされます。",
		stretch_rerun_blocked: "伸長はすでに適用されており、画像への最後の変更ではなくなっているため、この実行では置き換えられません（2回目の伸長が重ねて適用されます）。リニア画像から再度伸長するには、スタックのステップから処理をやり直してください。",
		...
		finalize_failed_reason: "結果をライブラリに保存中にエラーが発生しました：{0}",
		finalize_busy_reason: "この画像では別のステップがまだ実行中です",
		...
		resume_title: "前回のセッションを再開しますか？",
		resume_body: "{0} に以前の結果が見つかりました。再開すると、再キャリブレーションや再スタックを行わず、保存済みの画像から続行します。新規開始すると、このフォルダの内容が削除されます。",
		resume_failed_title: "再開に失敗しました",
		resume_failed_body: "以前の結果を読み込めませんでした: {0}",
		btn_resume: "再開",
		btn_start_fresh: "新規開始",
		fresh_cleanup_failed_title: "以前の結果を削除できませんでした",
		fresh_cleanup_failed_body: "そのまま新規開始しますが、以前のファイルを削除できませんでした: {0}",
	},
	wizard: {
