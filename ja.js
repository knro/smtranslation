const ja = {
	...
	connect: {
		...
		observatory: {
			...
			stream_access: "ライブ動画ストリームアクセス",
			public_access: "公開アクセス",
			connect_angelcam: "Angelcamと接続",
			no_cameras_available: "利用可能なカメラがありません。カメラにアクセスするにはAngelcamと接続してください。",
			view_mode: "表示モード",
		},
	...
	skymap: {
		...
		tooltip_push_assistant:
			"この機能は、カメラを使って高度計を手動で調整するのに役立ちます。天文マップ上で目的の天体または位置を選択し、プレートソルブ処理を開始するだけです。アプリのガイドに従って、ターゲットが天体の中心に位置するまで、天体を繰り返し調整します。プレートソルブ処理間の遅延を調整することで、画像がぼやけることなく天体を動かすのに十分な時間を確保できます。",
	},
	device: {
