const ja = {
	...
	tooltip: {
		...
		reset_ekoslive: "すべての画像とサムネイルを再生成する",
		reset_desktop: "デスクトップ Plasma ファイルを設定にコピーする",
		reset_network: "接続済み WiFi を含むすべてのネットワーク設定をリセットする",
		reset_driver_config: "すべての INDI ドライバー設定ファイルとログを削除します。"
	},
	splash: {
