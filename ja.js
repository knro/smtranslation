const ja = {
	...
	eula: {
		title: "ユーザー契約",
		introduction:
			"StellarMate へようこそ。ログインすると、StellarMate 利用規約、プライバシーポリシー、および以下に要約されたコミュニティガイドラインに同意したことになります。",
		title_zero_tolerance: "ゼロトレランス",
		zero_tolerance:
			"ゼロトレランス：StellarMate は、不適切なコンテンツと虐待的なユーザーに対してゼロトレランス方針をとっています。嫌がらせ、ヘイトスピーチ、露骨またはNSFWな内容、なりすまし、スパム、プライバシー侵害は固く禁止されています。",
		...
		terms_link: "stellarmate.com で完全な利用規約を読む",
		privacy_link: "stellarmate.com でプライバシーポリシーを読む",
		agree: "同意する",
		decline: "拒否",
	},
	menu: {
