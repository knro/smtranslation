﻿const cn = {
	...
	cloud: {
		...
		gallery_drawer: {
			...
			ai_search: "AI 搜索",
			delete_all_action: "全部删除",
			delete_folder: "删除文件夹",
			files_in_folder: "此文件夹中的文件",
			frames: "帧",
			frame_rate: "帧率",
			used_free: "已使用 {0} · 剩余 {1}",
			recent: "最近",
			playback_unsupported: "此文件类型不支持播放",
		},
		info_drawer: {
	...
	stella: {
		...
		narrate: "叙述响应",
		clear_chat: "清除聊天",
		clear_chat_confirm: "这将永久删除您与 Stella 的对话记录。",
		try_asking: "试着问",
		show_suggestions: "显示建议",
		thinking: "Stella 正在思考…",
		input_placeholder: "让 Stella 聚焦、拍摄或运行序列…",
		waiting_response: "正在等待 Stella 的回复…",
		attach_image: "附加图片",
		voice_input: "语音输入",
		sequence_ready: "拍摄序列已就绪",
		scheduler_ready: "计划任务已就绪",
		prompts_left: "剩余提问次数",
		notifications: {
	...
	postprocessing: {
		...
		btn_finalize: "完成并保存",
		btn_save_short: "保存",
		btn_publish_ekoslive: "发布",
		publish_no_image: "发布到 EkosLive 之前请先处理图像。",
		publish_failed_title: "发布失败",
		publish_failed_body: "为 EkosLive 准备图像时出错。",
		publish_no_equipment: "发布前请在 EkosLive 上设置天文台和设备配置文件。",
		publish_dialog_title: "发布到 EkosLive",
		publish_using: "使用 {0} · {1}",
		publish_frames_summary: "{0} 个滤镜 · 总积分 {1} 小时",
		publish_success: "已发布到 EkosLive。",
		btn_cancel: "取消",
		keep_editing: "继续编辑",
		method: "方法",
		stretch_linked: "链接通道",
		stretch_neutralize: "中和背景",
		btn_defaults: "默认值",
		reset_step: "恢复此步骤的默认设置",
		confirm_defaults_title: "将所有设置恢复为默认值？",
		confirm_defaults_body: "此步骤的当前设置将被丢弃。",
		status_pending: "等待中",
		status_running: "运行中…",
		status_completed: "完成",
		status_skipped: "已跳过",
		...
		stretch_curve_description: "叠加在自动拉伸之上——关闭则仅使用自动拉伸。",
		stretch_manual_description: "不使用自动拉伸：由曲线自身拉伸图像，并映射到图像自身的亮度范围。",
		stretch_manual_range: "不使用自动拉伸：由曲线自身拉伸图像，并映射到其自身的亮度范围（{0} 至 {1}）。",
		stretch_rerun_blocked: "拉伸已经应用，且它不再是图像的最后一次修改，因此本次运行无法替换它——会在第一次拉伸之上再叠加一次拉伸。请从「叠加」步骤重新运行流程，以便从线性图像重新拉伸。",
		...
		resume_title: "是否恢复上次会话？",
		resume_body: "在 {0} 中找到了之前的结果。恢复将从已保存的图像继续，而不会重新校准和叠加。重新开始将删除该文件夹的内容。",
		resume_failed_title: "恢复失败",
		resume_failed_body: "无法加载之前的结果：{0}",
		btn_resume: "恢复",
		btn_start_fresh: "重新开始",
		fresh_cleanup_failed_title: "无法清除之前的结果",
		fresh_cleanup_failed_body: "仍将重新开始，但无法删除之前的文件：{0}",
	},
	wizard: {
