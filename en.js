const en = {
	...
	targets: {
		object_types: {
			...
			GaseousNebulae: "Gaseous Nebulae",
			PlanetaryNebulae: "Planetary Nebulae",
			Galaxies: "Galaxies",
			Comets: "Comets",
			Asteroids: "Asteroids",
		...
		magnitude: "Magnitude",
		usable_duration: "Usable Duration",
		start: "Start",
		end: "End",
		...
		wind: "Wind",
		gust: "gust",
		no_forecast_data: "No forecast data for this location yet.",
		moon: "Moon",
		sun: "Sun",
		search: "Search",
		...
		ask_stella: "Ask Stella",
		add_to_list: "Add to List",
		fov_profile: "FOV Profile",
		fov_width: "FOV Width",
		fov_height: "FOV Height",
		calculate_fov: "Calculate FOV",
		fov_profile_name_hint: "My Camera FOV Profile",
		east_of_north: "E of N",
	...
	ekos: {
		...
		collapse_polar: {
			...
			waiting_for_update: "Waiting for next update",
	...
	cloud: {
		...
		gallery_drawer: {
			...
			ai_search: "AI Search",
			delete_all_action: "Delete All",
			delete_folder: "Delete Folder",
			files_in_folder: "Files in this folder",
			frames: "Frames",
			frame_rate: "Frame rate",
			used_free: "{0} used · {1} free",
			recent: "Recent",
			playback_unsupported: "Playback isn't supported for this file type",
		},
		info_drawer: {
	...
	postprocessing: {
		...
		btn_save_short: "Save",
		btn_publish_ekoslive: "Publish",
		publish_no_image: "Process an image before publishing to EkosLive.",
		publish_failed_title: "Failed to publish",
		publish_failed_body: "There was an error while preparing the image for EkosLive.",
		publish_no_equipment: "Set up an observatory and equipment profile on EkosLive before publishing.",
		publish_dialog_title: "Publish to EkosLive",
		publish_using: "Using {0} · {1}",
		publish_frames_summary: "{0} filters · {1}h total integration",
		publish_success: "Published to EkosLive.",
		btn_cancel: "Cancel",
		keep_editing: "Keep Editing",
		method: "Method",
		stretch_linked: "Link Channels",
		stretch_neutralize: "Neutralize Background",
		btn_defaults: "Defaults",
		reset_step: "Restore this step's defaults",
		confirm_defaults_title: "Reset all settings to default?",
		confirm_defaults_body: "This will discard your current settings for this step.",
		...
		stretch_curve_description: "Applied on top of the autostretch — leave it off to stretch with the autostretch alone.",
		stretch_manual_description: "No autostretch: the curve itself stretches the image, mapped onto the image's own brightness range.",
		stretch_manual_range: "No autostretch: the curve itself stretches the image, mapped onto its own brightness range ({0} to {1}).",
		stretch_rerun_blocked: "Stretch is already applied, and it is no longer the last change to the image, so this run can't replace it — it would stack a second stretch on top of the first. Re-run the pipeline from the Stack step to stretch again from the linear image.",
		...
		combine_normalize: "Match Channel Levels",
		...
		finalize_failed_reason: "There was an error while saving the result to the library: {0}",
		finalize_busy_reason: "another step is still running on this image",
		...
		resume_title: "Resume from previous session?",
		resume_body: "Previous results were found in {0}. Resuming continues from the saved image instead of re-calibrating and re-stacking. Starting fresh will delete the contents of that folder.",
		resume_failed_title: "Resume failed",
		resume_failed_body: "Could not load the previous result: {0}",
		btn_resume: "Resume",
		btn_start_fresh: "Start Fresh",
		fresh_cleanup_failed_title: "Could not clear previous results",
		fresh_cleanup_failed_body: "Starting fresh anyway, but the previous files could not be removed: {0}",
	},
	wizard: {
