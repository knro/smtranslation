const en = {
	...
	connect: {
		...
		observatory: {
			...
			stream_access: "Live Video Stream Access",
			public_access: "Public access",
			connect_angelcam: "Connect with Angelcam",
			no_cameras_available: "No camera available. Please connect with Angelcam to access your cameras.",
			view_mode: "View Mode",
